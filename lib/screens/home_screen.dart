                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  p.user?.fullName.split(' ').first ?? 'User',
                                  style: const TextStyle(
                                    color: Colors.white,
                                    fontSize: 22,
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                '${p.onTimePayments} On-Time Payments',
                                style: const TextStyle(
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Text(
                  late ? '⚠️ Loan Overdue!' : '📋 Active Loan',
                  style: const TextStyle(
                    color: Colors.white,
                    fontWeight: FontWeight.bold,
                    fontSize: 16,
                ...
                Container(
                  ...
                  child: Text(
                    late ? '${days.abs()}d late' : '${days}d left',
                    style: const TextStyle(
                      color: Colors.white, fontSize: 12),
                  ),
                ),
